...
def mass_estimated_from_radius_assuming_rockyish(self, distribution=False, **kw):
    ...
    distribution : bool
        ...
        which can be used for error propagation.
    """
    mu = np.array([3.395e00, -1.000e-03, -2.630e-01, -1.345e00])
    m, b, m_sigma, b_sigma = mu
    covariance_matrix = np.array(
        [
            [9.92306400e-04, 3.08188824e-05, -5.21201960e-04, -9.20479438e-04],
            [3.08188824e-05, 8.54410574e-04, 7.64582766e-06, 7.91519234e-05],
            [-5.21201960e-04, 7.64582766e-06, 1.62727147e-03, 2.80883165e-03],
            [-9.20479438e-04, 7.91519234e-05, 2.80883165e-03, 1.08430253e-02],
        ]
    )
