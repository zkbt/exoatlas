...
def mass_estimated_from_radius_assuming_rockyish(self, distribution=False, **kw):
    ...
    distribution : bool
        ...
        which can be used for error propagation.
    """
    mu = np.array([3.375, 0.043, -0.177, -1.043])
    m, b, m_sigma, b_sigma = mu
    covariance_matrix = np.array(
        [
            [8.20636531e-04, 7.86303479e-05, -2.94668366e-04, -5.37484182e-04],
            [7.86303479e-05, 1.12764202e-03, 1.02702647e-04, 5.50881511e-04],
            [-2.94668366e-04, 1.02702647e-04, 1.23774801e-03, 2.35773841e-03],
            [-5.37484182e-04, 5.50881511e-04, 2.35773841e-03, 1.04715771e-02],
        ]
    )
