...
def update_planet(pop):
    ...
    pop.update_planet("HD 80606b", transit_duration=0.4958, a_over_r=94, b=0.75)

    pop.update_planet("GJ 1132b", transit_duration=47.0 / 60.0 / 24.0)

    pop.update_planet("GJ 1214b", transit_duration=0.03620)

    pop.update_planet("GJ 436b", transit_duration=0.04227)
    ...
    pop.update_planet("LHS 1140b", transit_duration=2.0 / 24.0, a_over_r=101.0, b=0.16)

    pop.update_planet("GJ 3470b", transit_duration=0.07992)

    pop.update_planet("Kepler-51b", transit_duration=0.24154)

    pop.update_planet("Kepler-51c", transit_duration=0.1171)

    pop.update_planet("Kepler-51d", transit_duration=0.351992)

    pop.update_planet("Kepler-42b", transit_duration=0.022329)

    pop.update_planet("Kepler-42c", transit_duration=0.02)

    pop.update_planet("Kepler-42d", transit_duration=0.016554)

    pop.update_planet("WASP-43b", transit_duration=0.0483, a_over_r=4.8, b=0.66)
    ...
    pop.update_planet("GJ 436b", stellar_teff=3416.0)
    ...
    pop.update_planet("HD 97658b", a_over_r=26.24)
    ...
    # from Carter et al.
    pop.update_planet("Kepler-36b", a_over_r=15.24)
    ...
    pop.update_planet("Kepler-11b", stellar_radius=1.053)
    pop.update_planet("Kepler-11c", stellar_radius=1.053)
    pop.update_planet("Kepler-11d", stellar_radius=1.053)
    pop.update_planet("Kepler-11e", stellar_radius=1.053)
    pop.update_planet("Kepler-11f", stellar_radius=1.053)
    pop.update_planet("Kepler-11g", stellar_radius=1.053)

    # googling the ones that have messed up stellar_teffs
    pop.update_planet("Qatar-1b", stellar_teff=4861.0)
    pop.update_planet("Kepler-450b", stellar_teff=6215.0)
    pop.update_planet("Kepler-450c", stellar_teff=6215.0)
    pop.update_planet("Kepler-450d", stellar_teff=6215.0)

    pop.update_planet("Kepler-449b", stellar_teff=5588.0)
    pop.update_planet("Kepler-449c", stellar_teff=5588.0)

    pop.update_planet("Kepler-414b", stellar_teff=5523.0)
    pop.update_planet("Kepler-414c", stellar_teff=5523.0)

    pop.update_planet("Kepler-415b", stellar_teff=4523.0)
    pop.update_planet("Kepler-415c", stellar_teff=4523.0)

    pop.update_planet("Kepler-416b", stellar_teff=5670.0)
    pop.update_planet("Kepler-416c", stellar_teff=5670.0)

    pop.update_planet("Kepler-417b", stellar_teff=5376.0)
    pop.update_planet("Kepler-417c", stellar_teff=5376.0)

    # from discovery paper
    pop.update_planet("WASP-100b", stellar_radius=2.0)
    ...
    # from discovery paper
    pop.update_planet("Kepler-128b", mass=np.nan)
    pop.update_planet("Kepler-128c", mass=np.nan)
